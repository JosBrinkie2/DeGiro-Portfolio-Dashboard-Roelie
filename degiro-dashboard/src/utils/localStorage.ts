...
export function loadAccountData(account: AccountName): { entries: AccountEntry[]; transactions: Transaction[] } | null {
  try {
...
export function saveAccountData(account: AccountName, entries: AccountEntry[], transactions: Transaction[]): void {
  try {
